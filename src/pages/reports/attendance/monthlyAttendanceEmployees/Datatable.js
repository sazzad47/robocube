  ...
  return (
    <React.Fragment>
      <table className="table table-bordered text-center">
        <tbody>
          <tr>
            <td className="w-25 font-weight-bold">Dept.</td>
            <td className="w-25">Admin</td>
            <td className="w-25 font-weight-bold">Name</td>
            <td className="w-25">Amirah</td>
          </tr>
          <tr>
            <td className="w-25 font-weight-bold">Period</td>
            <td className="w-25">2023-04-01~2023-04-30</td>
            <td className="w-25 font-weight-bold">Emp. No</td>
      ...
      <table className="table table-bordered text-center">
        <tbody>
          ...
          <tr>
            ...
            <td colSpan="2" className="font-weight-bold text-secondary">
              Rest{" "}
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td>3</td>
            <td className="">Mon</td>
            <td colSpan="2" className="font-weight-bold text-danger">
              Absent
            </td>
          </tr>
          <tr>
